...
We trained a toy Transformer layer on an auto-regressive task. The proposed method (using Smooth Parametrization) matches the convergence profile of Sinkhorn almost perfectly (Figure \ref{fig:loss}), with a final loss difference of $<0.1\%$, while training \textbf{2.53$\times$} faster end-to-end.
